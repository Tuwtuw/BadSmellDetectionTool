...
const bad_smells_hook_1 = __importDefault(require("./bad-smells.hook"));
const styled = __importStar(require("./bad-smells.styles"));
const react_router_dom_1 = require("react-router-dom");
function BadSmells(props) {
    const { className, style } = props;
    const { Title, Text } = antd_1.Typography;
    const { columns, deleteModalOpen, setDeleteModalOpen } = (0, bad_smells_hook_1.default)(props);
    return ((0, jsx_runtime_1.jsxs)(styled.BadSmells, Object.assign({ className: `${className !== null && className !== void 0 ? className : ''}`.trim(), style: style }, { children: [(0, jsx_runtime_1.jsxs)("div", Object.assign({ className: "header" }, { children: [(0, jsx_runtime_1.jsx)(Title, { children: "Bad Smells" }, void 0), (0, jsx_runtime_1.jsx)(react_router_dom_1.Link, Object.assign({ to: "/badsmells/new" }, { children: (0, jsx_runtime_1.jsx)(antd_1.Button, { children: "New Bad Smell" }, void 0) }), void 0)] }), void 0), (0, jsx_runtime_1.jsx)(antd_1.Table, { dataSource: [], columns: columns, bordered: true, expandable: {
...
exports.default = (0, react_1.memo)(BadSmells);
//# sourceMappingURL=bad-smells.js.map